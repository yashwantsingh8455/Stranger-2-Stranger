  ...
  socket.on("chat message", async data => {
    ...
    try {
      ...
      if (type === "text" && typeof socialFeatures !== "undefined") {
        ...
        for (const uid of mentioned) await socialFeatures.helpers.notify(uid, "mention", `${currentUser.name} mentioned you in chat.`, { messageId: payload.id, room });
      }
  ...
  socket.on("group_message", async data => {
    ...
    try {
      ...
      if (type === "text" && typeof socialFeatures !== "undefined") {
        ...
        for (const uid of mentioned) await socialFeatures.helpers.notify(uid, "mention", `${currentUser.name} mentioned you in ${groupDoc?.name || "a group"}.`, { messageId: payload.id, room: roomName, groupId });
      }
