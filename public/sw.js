const CACHE = 's2s-social-v2';
const SHELL = ['/', '/login', '/discover', '/Group-Chatroom', '/white-sky-ui.css', '/social.css', '/manifest.json', '/icons/icon-192x192.png'];
...
self.addEventListener('push', event => {
  let data = { title: 'Stranger 2 Stranger', body: 'You have a new update.', link: '/discover#notifications' };
...
self.addEventListener('notificationclick', event => {
  ...
  const link = event.notification.data?.link || '/discover#notifications';
